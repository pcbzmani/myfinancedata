...
export default function Settings() {
    ...
    useEffect(() => {
        api.get('/settings').then(d => { if (d.scriptUrl)
    ...
    const handleTest = async () => {
        setTesting(true);
        setTestResult(null);
        const r = await api.get('/settings/test');
