...
const MARKET_TYPES = ['stocks', 'mutual_fund']; // price auto-fetched by Google Sheets
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    try {
      await addRow('investments', {
        ...
        // For stocks/MF: 0 placeholder — Apps Script overwrites with GOOGLEFINANCE formula
        // For others: user-entered value
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {isMarketType && (
                <div className="sm:col-span-2">
                  ...
                  <input
                    placeholder={form.type === 'stocks' ? 'e.g. INFY.NS, RELIANCE.NS, TCS.NS' : 'e.g. 0P0001ISIZ.BO'}
                    value={form.symbol}
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    NSE: <span className="font-mono">SYMBOL.NS</span> · BSE: <span className="font-mono">SYMBOL.BO</span> · US: <span className="font-mono">AAPL</span>
                    <span className="ml-2 text-emerald-600 font-medium">· Live price auto-updated by Google Sheets</span>
                  </p>
                </div>
              )}
